...
if ($job_post_id !== null) {
    $select_query = "SELECT
                             jp.job_post_name,jp.job_post_id,
                             d.department_name
                             FROM job_post jp
...
if (isset($_POST['submit'])) {
    $job_post_name = $_POST['job_post_name'];
    ...
    $update_query = "UPDATE job_post jp
    SET job_post_name = '$job_post_name'  
    FROM training_relations tr
    JOIN department d ON tr.department_id = d.department_id
    WHERE 
       jp.job_post_id = tr.job_post_id AND
       jp.job_post_id = $job_post_id";
