            ...
            <div class="wrapper">
                <section class="pst">
                    ...
                    if (isset($_POST['submit'])) {
                        ...
                        $emp_department = $_POST['department_name'];
                        ...
                        if ($emp_first_name == '' or $emp_last_name == '' or $emp_department == '' or $emp_job_post == '' or $emp_email == '' or $emp_phone == '' or $emp_image == '') {
                            echo "<script>
                            ...
                            move_uploaded_file($tmp_image, "db_img/$emp_image");
                    
                            $insert_user = "INSERT INTO employee_records (emp_first_name,emp_last_name,emp_department_name,emp_job_post_name,emp_email,emp_mobile,emp_image,emp_status) VALUES ('$emp_first_name','$emp_last_name','$emp_department','$emp_job_post','$emp_email','$emp_phone','$emp_image','$status')";
                        ...
                        <div class="pdetail">
                                ...
                                <div class="fld">
                                    ...
                                    <select name="department_name">
                                        ...
                                        while ($row = pg_fetch_assoc($result_query)) {
                                            ...
                                            echo "<option value='$emp_department_name'>$emp_department_name</option>";
                                        }
                                ...
                                <div class="fld">
                                    ...
                                    <select name="job_post_name">
                                        ...
                                        while ($row = pg_fetch_assoc($result_query)) {
                                            ...
                                            echo "<option value='$emp_job_post'>$emp_job_post</option>";
                                        }
                            ...
                            <div class="f">
                                <div class="fld">
                                    ...
                                    <input type="email" name="emp_email" id="email" placeholder="Email@gmail.com"
                                        required>
