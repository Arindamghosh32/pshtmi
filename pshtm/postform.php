...
<body>
    ...
    <div class="bxp container">
        <div class="editor">
            ...
            <div class="sv">
                <button type=""><i class="fa-regular fa-floppy-disk"></i>Create Form</button>
            </div>
            ...
            <div class="htmle inputfld" id="htmled">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <textarea id="numberer" name="numberer" cols="30" rows="10" class="textarea"
                        placeholder="Enter Numeric Question"></textarea>

                    <input type="text" name="input_type" id="input_type" value="number" hidden>

                    <button type="button" onclick="createInput1('number'); submitForm1()"><i
                            class="fa-regular fa-share-from-square"></i>Save</button>
            ...
            <script>
                ...
                function submitForm1() {
                   ...
                   xhttp.open("POST", "n_post_data.php", true);
                   xhttp.send(Datax);
            ...
            <div class="htmle inputfld" id="oneline">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <textarea id="oneliner" name="oneliner" cols="30" rows="10" class="textarea"
                        placeholder="Enter Question"></textarea>

                    <input type="text" name="input_type" id="input_type2" value="text" hidden>

                    <button type="button" onclick="createInput('text'); submitForm2()"><i
                            class="fa-regular fa-share-from-square"></i>Save</button>
            ...
            <script>
                ...
                function submitForm2() {
                   ...
                   xhttp.open("POST", "o_post_data.php", true);
                   xhttp.send(Datax);
            ...
            <div class="htmle inputfld" id="multiline">
                <form action="" method="POST" enctype="multipart/form-data">
                    ...
                    <textarea id="multiliner" name="multiliner" cols="30" rows="10" class="textarea"
                        placeholder="Enter Question"></textarea>
            ...
            <script>
                function submitForm3() {
                   ...
                   xhttp.open("POST", "m_post_data.php", true);
                   xhttp.send(Datax);
            ...
            <div class="htmle inputfld" id="mcq">
                <form action="" method="POST" enctype="multipart/form-data">
                    <label for="">MCQ</label>
                    <textarea id="mcqer" name="mcqer" cols="30" rows="10" class="textarea"
                        placeholder="Enter Question"></textarea>
                    ...
                    <button type="button" id="" onclick="generateMCQ(); submitForm4()"><i
                            class="fa-regular fa-share-from-square"></i>Save</button>
            ...
            <script>
                ...
                function submitForm4() {
                   ...
                   xhttp.open("POST", "mcq_post_data.php", true);
                   xhttp.send(Datax);
