        ...
        <div class="editor">
            ...
            <script>
                ...
                function submitForm1() {
                   ...
                   xhttp.open("POST", "n_pre_data.php", true);
                   xhttp.send(Datax);
            ...
            <script>
                ...
                function submitForm2() {
                   ...
                   xhttp.open("POST", "o_pre_data.php", true);
                   xhttp.send(Datax);
            ...
            <script>
                function submitForm3() {
                   ...
                   xhttp.open("POST", "m_pre_data.php", true);
                   xhttp.send(Datax);
            ...
            <script>
                ...
                function submitForm4() {
                   ...
                   xhttp.open("POST", "mcq_pre_data.php", true);
                   xhttp.send(Datax);
